...
This project demonstrates professional data engineering practices suitable for production environments and makes an excellent portfolio piece for data engineers.